...
const Dashboard = () => {
  ...
  async function DoctorRegistration(e) {
    e.preventDefault();
    await setDoc(doc(db, "Doctor", doctor.Uid), doctor)
      .then(() => {
                    ...
                    <div class="user__details">
                      ...
                      <div class="input__box">
                        ...
                        <input
                          ...
                          value={
                            getdatadoctor.Specialization != null
                              ? getdatadoctor.Specialization
                              : null
                          }
                          onChange={(e) => {
                            setdoctor({
                      ...
                      <div class="category">
                        ...
                        <label for="dot-2">
                          <span
                            class="dot two"
                            onClick={() => {
                              setdoctor({ ...doctor, Gender: "Female" });
                            }}
                          ></span>
                          <span>Female</span>
                        </label>
